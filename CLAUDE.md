...
| `dot_local/bin/executable_aws-switch` / `executable_aws-login` / `executable_aws-logout` / `executable_aws-auth-ensure` / `dot_aws/create_config` | `docs/aws-cheatsheet.md` |
